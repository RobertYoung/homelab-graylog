...
Ansible project for deploying [Graylog](https://graylog.org/) via Docker Compose on a single host.

**Target host:** `graylog.local.iamrobertyoung.co.uk`
...
├── inventories/
│   ├── hosts.yml               # Inventory with graylog group
│   └── group_vars/             # Group variables
├── host_vars/                  # Host-specific variables
├── roles/
│   └── graylog/                # Custom Graylog role
...
| `graylog` | Custom | Graylog deployment |
